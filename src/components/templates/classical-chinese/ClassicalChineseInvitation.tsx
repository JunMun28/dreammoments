...
const headingFont: CSSProperties = {
	fontFamily: "'Cormorant', 'Noto Serif SC', Georgia, serif",
};
...
const accentFont: CSSProperties = {
	fontFamily: "'Cormorant', 'Noto Serif SC', serif",
	fontWeight: 700,
};
...
function BrushDivider({ className = "" }: { className?: string }) {
	return (
		<DrawPath
			d="M0,20 Q30,5 60,18 Q90,32 120,15 Q150,2 180,20"
...
export default function ClassicalChineseInvitation({
	...
	return (
		<div className="classical-chinese" style={bodyFont} lang="zh-Hans">
			{/* ════════════════════════════════════════════
			    1. HERO — Obsidian bg with ink-brush 囍 and ink drop particles
			    ════════════════════════════════════════════ */}
			<SectionShell
				sectionId="hero"
				mode={mode}
			...
			>
				...
				{/* Ink drop particle atmosphere */}
				<ParticleField preset="inkDrops" />
				...
				<div className="relative z-10 mx-auto flex min-h-[100svh] max-w-4xl flex-col items-center justify-center px-6 py-20 text-center">
					{/* Animated 囍 character — DrawPath stroke then fill */}
					<DrawPath
						d="M10,5 L10,45 M5,25 L15,25 M20,5 L20,45 M15,25 L25,25 M30,5 L30,25 Q30,45 15,45 M35,5 L35,25 Q35,45 50,45 M55,5 L55,45 M50,25 L60,25 M65,5 L65,45 M60,25 L70,25 M75,5 L75,25 Q75,45 60,45 M80,5 L80,25 Q80,45 95,45"
						stroke={COLORS.primary}
						strokeWidth={2.5}
						width={100}
						height={50}
					...
					<Reveal direction="scale">
						<h1 style={accentFont} className="mt-8 text-4xl sm:text-6xl">
							<span
			...
			>
				<div className="mx-auto max-w-3xl text-center">
					...
					<Reveal direction="up" delay={0.2}>
						<div
							className="mx-auto mt-8 max-w-2xl rounded-lg border border-[rgba(184,134,11,0.15)] p-8"
							style={{ background: "rgba(245,240,232,0.06)" }}
						>
							<div className="cc-blockquote mx-auto max-w-2xl text-left">
								<p
									{...editableProps(
							...
							data.venue.coordinates?.lng != null ? (
								<div className="mt-6 flex flex-wrap justify-center gap-3">
									<a
										...
										className="inline-flex items-center gap-1.5 rounded-full border px-5 py-2.5 text-xs uppercase tracking-[0.15em] transition-colors"
										style={{
			...
			<SectionShell
				...
				onSelect={onSectionSelect}
				onAiClick={onAiClick}
				className="cc-section-obsidian relative overflow-hidden px-6 pb-20 pt-16 text-center sm:px-10"
			>
				<div className="mx-auto max-w-3xl">
					...
					<Reveal direction="scale">
						<p
							className="cc-gold-shimmer mt-8 text-6xl"
							style={accentFont}
							aria-hidden="true"
						>
							囍
