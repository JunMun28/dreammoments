			...
			<div className="mx-auto max-w-[90rem] px-6 pb-16 pt-24 text-center sm:text-left lg:px-24 lg:pb-24 lg:pt-32 2xl:max-w-[112.5rem] min-[120rem]:max-w-[137.5rem]">
				...
				<div className="mt-10">
					<Link
						...
						className="inline-flex w-full items-center justify-center rounded-full bg-background px-8 py-4 text-lg font-medium text-foreground transition-colors hover:bg-background/90 sm:w-auto"
					>
						Start Creating
					</Link>
				</div>
