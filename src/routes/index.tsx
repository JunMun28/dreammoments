			...
			<div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
				...
				>
					...
					<h1 className="font-heading text-6xl sm:text-7xl lg:text-8xl leading-[0.95] tracking-tight mb-8">
						...
						<span className="text-[color:var(--dm-peach)] italic">warmly</span>{" "}
						yours.
					</h1>
					...
					{templates.map((t, i) => (
						...
						>
							...
							>
								...
								>
									<div className="absolute inset-4 rounded-[2rem] overflow-hidden bg-white/40 border border-white/50 backdrop-blur-sm shadow-sm transition-shadow duration-500 group-hover:shadow-md">
										<div className="h-full w-full flex items-center justify-center opacity-30">
											<Heart
												aria-hidden="true"
												className="w-16 h-16 text-[color:var(--dm-ink)]"
											/>
										</div>
									</div>
								</div>
