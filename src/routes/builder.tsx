 ...
 * Uses InvitationBuilder component which handles both card and longpage layouts,
 * automatically rendering all template sections (hero, schedule, venue, photos, RSVP).
 */
function BuilderPage() {
	const { invitation } = Route.useLoaderData();

	// Cast layoutFormat to the expected union type (with fallback)
	const layoutFormat =
		invitation.layoutFormat === "card" || invitation.layoutFormat === "longpage"
			? invitation.layoutFormat
			: "longpage";
