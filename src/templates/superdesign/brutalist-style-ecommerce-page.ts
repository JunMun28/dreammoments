...
export const brutalistStyleEcommercePageTemplate: TemplateConfig = {
	id: "sd-brutalist-style-ecommerce-page",
	name: "Bold Vows",
	nameZh: "铿锵誓言",
	description:
		"A high-fashion brutalist design system called 'Season 04', utilizing massive typography, raw noise textures, and a techn",
	category: "western",
	version: "1.0.0",
	aiConfig: {
