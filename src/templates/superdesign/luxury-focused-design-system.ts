...
export const luxuryFocusedDesignSystemTemplate: TemplateConfig = {
	id: "sd-luxury-focused-design-system",
	name: "Elegant Script",
	nameZh: "雅致篇章",
	description:
		"A luxury-focused, high-contrast design system called 'Super Travel' that uses bold geometric typography, a signature #e4",
	category: "garden",
	version: "1.0.0",
	aiConfig: {
