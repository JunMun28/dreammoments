...
export const cinematicNoirStyleTemplate: TemplateConfig = {
	id: "sd-cinematic-noir-style",
	name: "Silver Screen Love",
	nameZh: "光影之恋",
	description:
		"The Cinematic Noir design system leverages deep blacks, crisp off-whites, and a sophisticated typographic scale to creat",
	category: "garden",
	version: "1.0.0",
	aiConfig: {
