...
export const kineticOrangeStyleTemplate: TemplateConfig = {
	id: "sd-kinetic-orange-style",
	name: "Bold Vows",
	nameZh: "铿锵誓言",
	description:
		"The 'Kinetic Orange' style is a digital-first brutalist aesthetic that uses heavy typography and motion to create a sens",
	category: "modern",
	version: "1.0.0",
	aiConfig: {
	...
	tokens: {
		...
		typography: {
			headingFont: "'Archivo Black', 'Noto Sans SC', system-ui, sans-serif",
			bodyFont: "'Space Mono', 'Noto Sans SC', system-ui, sans-serif",
