...
export const synapseTemplate: TemplateConfig = {
	id: "sd-synapse",
	name: "Elegant Script",
	nameZh: "雅致篇章",
	description:
		"The Synapse design system is a futuristic, dark-themed interface that combines large-scale editorial typography with int",
	category: "western",
	version: "1.0.0",
	aiConfig: {
	...
	tokens: {
		...
		typography: {
			headingFont: "'Instrument Serif', 'Noto Sans SC', system-ui, sans-serif",
			bodyFont: "'Inter', 'Noto Sans SC', system-ui, sans-serif",
			accentFont: "'Instrument Serif', 'Noto Sans SC', system-ui, sans-serif",
		},
		animations: {
