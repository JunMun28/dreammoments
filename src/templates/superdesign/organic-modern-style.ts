...
export const organicModernStyleTemplate: TemplateConfig = {
	id: "sd-organic-modern-style",
	name: "Elegant Script",
	nameZh: "雅致篇章",
	description:
		"A refined, editorial-style interface that balances technological precision with human-centric organic elements, defined ",
	category: "garden",
	version: "1.0.0",
	aiConfig: {
	...
	tokens: {
		...
		typography: {
			...
			accentFont: "'DM Serif Display', 'Noto Sans SC', system-ui, sans-serif",
		},
		animations: {
