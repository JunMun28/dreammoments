...
export const neonVelocityCountdownTemplate: TemplateConfig = {
	id: "sd-neon-velocity-countdown",
	name: "Bold Vows",
	nameZh: "铿锵誓言",
	description:
		"The 'Neon Velocity' style guide is a minimalist yet aggressive design system that blends brutalist structure (heavy bord",
	category: "modern",
	version: "1.0.0",
	aiConfig: {
