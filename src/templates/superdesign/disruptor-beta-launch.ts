...
export const disruptorBetaLaunchTemplate: TemplateConfig = {
	id: "sd-disruptor-beta-launch",
	name: "Bold Vows",
	nameZh: "铿锵誓言",
	description:
		"The 'Disruptor' style guide is a bold, industrial-themed framework that merges brutalist architecture with modern UI com",
	category: "garden",
	version: "1.0.0",
	aiConfig: {
	...
	tokens: {
		...
		typography: {
			headingFont: "'Space Mono', 'Noto Sans SC', system-ui, sans-serif",
			bodyFont: "'Plus Jakarta Sans', 'Noto Sans SC', system-ui, sans-serif",
			accentFont: "'Archivo', 'Noto Sans SC', system-ui, sans-serif",
		},
		animations: {
