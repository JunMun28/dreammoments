...
export const midnightEditorialStyleTemplate: TemplateConfig = {
	id: "sd-midnight-editorial-style",
	name: "Bold Vows",
	nameZh: "铿锵誓言",
	description:
		"The 'Midnight Editorial' style blends brutalist typography with high-end fashion aesthetics. It utilizes a dark, monochr",
	category: "western",
	version: "1.0.0",
	aiConfig: {
