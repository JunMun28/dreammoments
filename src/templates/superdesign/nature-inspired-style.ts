...
export const natureInspiredStyleTemplate: TemplateConfig = {
	id: "sd-nature-inspired-style",
	name: "Elegant Script",
	nameZh: "雅致篇章",
	description:
		"An earthy, high-end editorial style combining bold industrial typography with soft organic colors and fluid, scroll-trig",
	category: "garden",
	version: "1.0.0",
	aiConfig: {
