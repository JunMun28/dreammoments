...
export const boldEditorialDesignStyleTemplate: TemplateConfig = {
	id: "sd-bold-editorial-design-style",
	name: "Bold Vows",
	nameZh: "铿锵誓言",
	description:
		"Create a high-end, premium portfolio system using a dark navy base (#171e19), massive Anton display typography, and an a",
	category: "western",
	version: "1.0.0",
	aiConfig: {
	...
	tokens: {
		...
		typography: {
			headingFont: "'Plus Jakarta Sans', 'Noto Sans SC', system-ui, sans-serif",
			bodyFont: "'Inter', 'Noto Sans SC', system-ui, sans-serif",
			accentFont: "'Plus Jakarta Sans', 'Noto Sans SC', system-ui, sans-serif",
		},
		animations: {
