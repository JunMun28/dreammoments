...
export const boldRetroModernismTemplate: TemplateConfig = {
	id: "sd-bold-retro-modernism",
	name: "Bold Vows",
	nameZh: "铿锵誓言",
	description:
		"A striking, high-contrast editorial design system blending 1970s retro aesthetics with modern brutalist layouts, featuri",
	category: "western",
	version: "1.0.0",
	aiConfig: {
