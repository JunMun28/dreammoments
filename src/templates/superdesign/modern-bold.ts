...
export const modernBoldTemplate: TemplateConfig = {
	id: "sd-modern-bold",
	name: "Elegant Script",
	nameZh: "雅致篇章",
	description:
		"Bold Typography is **poster design translated to web**. Typography isn't decoration—it's the entire visual language. Eve",
	category: "chinese",
	version: "1.0.0",
	aiConfig: {
	...
	tokens: {
		...
		typography: {
			...
			bodyFont: "'Playfair Display', 'Noto Sans SC', system-ui, sans-serif",
