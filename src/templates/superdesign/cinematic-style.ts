...
export const cinematicStyleTemplate: TemplateConfig = {
	id: "sd-cinematic-style",
	name: "Bold Vows",
	nameZh: "铿锵誓言",
	description:
		"The 'Cinematic Style' is an immersive, dark-mode design system using 3D spatial depth and high-contrast typography to cr",
	category: "western",
	version: "1.0.0",
	aiConfig: {
	...
	tokens: {
		...
		typography: {
			headingFont: "'Aspekta', 'Noto Sans SC', system-ui, sans-serif",
			bodyFont: "'Inter', 'Noto Sans SC', system-ui, sans-serif",
			accentFont: "'Aspekta', 'Noto Sans SC', system-ui, sans-serif",
		},
		animations: {
