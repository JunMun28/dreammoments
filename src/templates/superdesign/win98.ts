...
export const win98Template: TemplateConfig = {
	id: "sd-win98",
	name: "Pure Love",
	nameZh: "纯粹之爱",
	description:
	...
	tokens: {
		...
		typography: {
			headingFont: "'MS Sans Serif', 'Noto Sans SC', system-ui, sans-serif",
			bodyFont: "'Inter', 'Noto Sans SC', system-ui, sans-serif",
			accentFont: "'MS Sans Serif', 'Noto Sans SC', system-ui, sans-serif",
		},
		animations: {
