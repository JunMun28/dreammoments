...
export const cyberSerifStyleTemplate: TemplateConfig = {
	id: "sd-cyber-serif-style",
	name: "Crystal Dreams",
	nameZh: "水晶之梦",
	description:
		"The 'Cyber Serif' style creates a premium, avant-garde digital experience by pairing the elegance of serif display fonts",
	category: "chinese",
	version: "1.0.0",
	aiConfig: {
	...
	tokens: {
		...
		typography: {
			headingFont: "'Newsreader', 'Noto Sans SC', system-ui, sans-serif",
