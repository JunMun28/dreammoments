...
export const playfulTemplate: TemplateConfig = {
	id: "sd-playful",
	name: "Garden Bliss",
	nameZh: "花园之约",
	description:
		'The core concept is **"Stable Grid, Wild Decoration"**. The content itself (text, forms) lives in clean, readable areas,',
	category: "garden",
	version: "1.0.0",
	aiConfig: {
