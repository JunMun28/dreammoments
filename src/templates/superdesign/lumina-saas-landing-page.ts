...
export const luminaSaasLandingPageTemplate: TemplateConfig = {
	id: "sd-lumina-saas-landing-page",
	name: "Bold Vows",
	nameZh: "铿锵誓言",
	description:
		"A vibrant Neo-Brutalist SaaS landing page utilizing a dominant #ffe17c yellow, deep charcoal #171e19, and sage #b7c6c2 a",
	category: "modern",
	version: "1.0.0",
	aiConfig: {
	...
	tokens: {
		...
		typography: {
			headingFont: "'Cabinet Grotesk', 'Noto Sans SC', system-ui, sans-serif",
			bodyFont: "'Satoshi', 'Noto Sans SC', system-ui, sans-serif",
			accentFont: "'Cabinet Grotesk', 'Noto Sans SC', system-ui, sans-serif",
		},
		animations: {
