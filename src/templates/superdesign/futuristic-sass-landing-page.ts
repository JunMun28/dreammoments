...
export const futuristicSassLandingPageTemplate: TemplateConfig = {
	id: "sd-futuristic-sass-landing-page",
	name: "Crystal Dreams",
	nameZh: "水晶之梦",
	description:
		"Superdesign is a sophisticated, vibe-centric design system that blends deep slate atmospheric backgrounds with a clean, ",
	category: "modern",
	version: "1.0.0",
	aiConfig: {
	...
	tokens: {
		...
		typography: {
			headingFont: "'Inter', 'Noto Sans SC', system-ui, sans-serif",
			bodyFont: "'Sans', 'Noto Sans SC', system-ui, sans-serif",
			accentFont: "'Lora', 'Noto Sans SC', system-ui, sans-serif",
		},
		animations: {
