...
export const liquidMetalStyleTemplate: TemplateConfig = {
	id: "sd-liquid-metal-style",
	name: "Garden Bliss",
	nameZh: "花园之约",
	description: "Design Style: Acid Graphic (Liquid Chrome & Techno-Surrealism)",
	category: "chinese",
	version: "1.0.0",
	aiConfig: {
	...
	tokens: {
		...
		typography: {
			headingFont: "'Syne', 'Noto Sans SC', system-ui, sans-serif",
			bodyFont: "'Clash Display', 'Noto Sans SC', system-ui, sans-serif",
