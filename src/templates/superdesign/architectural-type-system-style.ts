...
export const architecturalTypeSystemStyleTemplate: TemplateConfig = {
	id: "sd-architectural-type-system-style",
	name: "Bold Vows",
	nameZh: "铿锵誓言",
	description:
		"Architectural Type System is a minimalist, monochrome aesthetic focusing on rigid grid structures, hairline borders, and",
	category: "garden",
	version: "1.0.0",
	aiConfig: {
	...
	tokens: {
		...
		typography: {
			headingFont: "'JetBrains Mono', 'Noto Sans SC', system-ui, sans-serif",
			bodyFont: "'Inter', 'Noto Sans SC', system-ui, sans-serif",
			accentFont: "'JetBrains Mono', 'Noto Sans SC', system-ui, sans-serif",
		},
		animations: {
