...
export const boldEditorialStudioStyleTemplate: TemplateConfig = {
	id: "sd-bold-editorial-studio-style",
	name: "Elegant Script",
	nameZh: "雅致篇章",
	description:
		"A sophisticated, typography-first creative studio aesthetic featuring a black-and-white color scheme, custom interactive",
	category: "western",
	version: "1.0.0",
	aiConfig: {
