...
export const chromeExtensionLandingPageTemplate: TemplateConfig = {
	id: "sd-chrome-extension-landing-page",
	name: "Modern Vows",
	nameZh: "摩登誓约",
	description:
		"Create a high-density, technical landing page that simulates a browser workspace. The design must feel like a functional",
	category: "modern",
	version: "1.0.0",
	aiConfig: {
	...
	tokens: {
		...
		typography: {
			...
			bodyFont: "'JetBrains Mono', 'Noto Sans SC', system-ui, sans-serif",
