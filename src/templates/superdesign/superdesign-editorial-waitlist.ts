...
export const superdesignEditorialWaitlistTemplate: TemplateConfig = {
	id: "sd-superdesign-editorial-waitlist",
	name: "Elegant Script",
	nameZh: "雅致篇章",
	description:
		"A minimalist, editorial-inspired landing page designed to convey 'quiet confidence' and exclusivity. It uses a dark matt",
	category: "chinese",
	version: "1.0.0",
	aiConfig: {
	...
	tokens: {
		...
		typography: {
			headingFont: "'Clash Grotesk', 'Noto Sans SC', system-ui, sans-serif",
			bodyFont: "'General Sans', 'Noto Sans SC', system-ui, sans-serif",
			accentFont: "'Clash Grotesk', 'Noto Sans SC', system-ui, sans-serif",
		},
		animations: {
