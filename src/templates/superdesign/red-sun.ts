...
export const redSunTemplate: TemplateConfig = {
	id: "sd-red-sun",
	name: "Elegant Script",
	nameZh: "雅致篇章",
	description:
		"The Red Sun system uses a bold coral primary color against a deep ink-blue foundation to create a modern, editorial aest",
	category: "western",
	version: "1.0.0",
	aiConfig: {
	...
	tokens: {
		...
		typography: {
			...
			bodyFont: "'Instrument Serif', 'Noto Sans SC', system-ui, sans-serif",
