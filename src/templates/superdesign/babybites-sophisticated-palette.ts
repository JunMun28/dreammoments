...
export const babybitesSophisticatedPaletteTemplate: TemplateConfig = {
	id: "sd-babybites-sophisticated-palette",
	name: "Crystal Dreams",
	nameZh: "水晶之梦",
	description:
		"A refined, modern parenting and health-focused design system using high-contrast colors (#171e19, #ca0013) paired with s",
	category: "modern",
	version: "1.0.0",
	aiConfig: {
