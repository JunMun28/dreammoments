...
export const terminalTemplate: TemplateConfig = {
	id: "sd-terminal",
	name: "Garden Bliss",
	nameZh: "花园之约",
	description:
		'The **Terminal CLI** aesthetic pays homage to the raw power of the command line. It strips away the "user interface" lay',
	category: "garden",
	version: "1.0.0",
	aiConfig: {
