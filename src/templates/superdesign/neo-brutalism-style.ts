...
export const neoBrutalismStyleTemplate: TemplateConfig = {
	id: "sd-neo-brutalism-style",
	name: "Bold Vows",
	nameZh: "铿锵誓言",
	description:
		"A bold, high-contrast Neo-Brutalist design system featuring heavy strokes, hard shadows, and an 'Acid' color palette wit",
	category: "garden",
	version: "1.0.0",
	aiConfig: {
