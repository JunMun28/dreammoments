...
export const architecturalBlueprintTemplate: TemplateConfig = {
	id: "sd-architectural-blueprint",
	name: "Crimson Promise",
	nameZh: "赤色承诺",
	description:
		'1. **The "Cyanotype" Logic**: Traditionally, blueprints are white lines on a deep blue background. This high-contrast, i',
	category: "chinese",
	version: "1.0.0",
	aiConfig: {
	...
	tokens: {
		...
		typography: {
			headingFont: "'Roboto Mono', 'Noto Sans SC', system-ui, sans-serif",
			bodyFont: "'Inter', 'Noto Sans SC', system-ui, sans-serif",
			accentFont: "'Roboto Mono', 'Noto Sans SC', system-ui, sans-serif",
		},
		animations: {
