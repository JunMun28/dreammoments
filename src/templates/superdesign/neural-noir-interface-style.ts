...
export const neuralNoirInterfaceStyleTemplate: TemplateConfig = {
	id: "sd-neural-noir-interface-style",
	name: "Elegant Script",
	nameZh: "雅致篇章",
	description:
		"A sophisticated dark-mode interface featuring neural network connectivity, glassmorphism, and a luxury gold-on-black col",
	category: "western",
	version: "1.0.0",
	aiConfig: {
	...
	tokens: {
		...
		typography: {
			...
			accentFont: "'Pro', 'Noto Sans SC', system-ui, sans-serif",
		},
		animations: {
