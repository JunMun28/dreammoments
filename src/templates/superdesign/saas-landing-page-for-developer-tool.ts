...
export const saasLandingPageForDeveloperToolTemplate: TemplateConfig = {
	id: "sd-saas-landing-page-for-developer-tool",
	name: "Natural Grace",
	nameZh: "自然之美",
	description:
		"A sophisticated, 'Reality-First' design system that rejects typical SaaS fluff in favor of a structured, modernist, and ",
	category: "garden",
	version: "1.0.0",
	aiConfig: {
	...
	tokens: {
		...
		typography: {
			headingFont: "'General Sans', 'Noto Sans SC', system-ui, sans-serif",
			bodyFont: "'Inter', 'Noto Sans SC', system-ui, sans-serif",
			accentFont: "'General Sans', 'Noto Sans SC', system-ui, sans-serif",
		},
		animations: {
