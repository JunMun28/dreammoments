...
export const cleanFluidTemplate: TemplateConfig = {
	id: "sd-clean-fluid",
	name: "Elegant Script",
	nameZh: "雅致篇章",
	description:
		"An editorial-tech hybrid style utilizing high-contrast typography, fluid micro-interactions, and a unique 'wave' layout ",
	category: "garden",
	version: "1.0.0",
	aiConfig: {
