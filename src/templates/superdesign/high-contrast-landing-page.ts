...
export const highContrastLandingPageTemplate: TemplateConfig = {
	id: "sd-high-contrast-landing-page",
	name: "Bold Vows",
	nameZh: "铿锵誓言",
	description:
		"A sophisticated, typography-first design system using heavy geometric sans-serifs, offset text layering (echoes), and a ",
	category: "chinese",
	version: "1.0.0",
	aiConfig: {
