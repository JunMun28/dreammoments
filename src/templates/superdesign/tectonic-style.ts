...
export const tectonicStyleTemplate: TemplateConfig = {
	id: "sd-tectonic-style",
	name: "Pure Love",
	nameZh: "纯粹之爱",
	description:
	...
	tokens: {
		...
		typography: {
			headingFont:
				"'Cormorant Garamond', 'Noto Sans SC', system-ui, sans-serif",
			bodyFont: "'Space Grotesk', 'Noto Sans SC', system-ui, sans-serif",
