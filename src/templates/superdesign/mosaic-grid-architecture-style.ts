...
export const mosaicGridArchitectureStyleTemplate: TemplateConfig = {
	id: "sd-mosaic-grid-architecture-style",
	name: "Pure Love",
	nameZh: "纯粹之爱",
	description:
		"A sophisticated, structural design system inspired by technical blueprints and high-end UI wireframes. It utilizes a lar",
	category: "modern",
	version: "1.0.0",
	aiConfig: {
