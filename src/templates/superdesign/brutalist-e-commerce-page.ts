...
export const brutalistECommercePageTemplate: TemplateConfig = {
	id: "sd-brutalist-e-commerce-page",
	name: "Bold Vows",
	nameZh: "铿锵誓言",
	description:
		"Raw Form is a high-contrast, brutalist design system that prioritizes typographic drama and atmospheric depth. It replac",
	category: "chinese",
	version: "1.0.0",
	aiConfig: {
	...
	tokens: {
		...
		typography: {
			headingFont: "'Clash Display', 'Noto Sans SC', system-ui, sans-serif",
			bodyFont: "'Satoshi', 'Noto Sans SC', system-ui, sans-serif",
			accentFont: "'Clash Display', 'Noto Sans SC', system-ui, sans-serif",
		},
		animations: {
