...
export const softlyDigitalWellnessAppTemplate: TemplateConfig = {
	id: "sd-softly-digital-wellness-app",
	name: "Garden Bliss",
	nameZh: "花园之约",
	description:
		"Design a 'Softly' themed mobile-first landing page for a digital wellness app using a warm, desaturated pastel palette, ",
	category: "garden",
	version: "1.0.0",
	aiConfig: {
