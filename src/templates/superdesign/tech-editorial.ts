...
export const techEditorialTemplate: TemplateConfig = {
	id: "sd-tech-editorial",
	name: "Elegant Script",
	nameZh: "雅致篇章",
	description:
		"A sophisticated editorial-style UI featuring a fixed background grid, high-contrast serif typography, and technical mono",
	category: "garden",
	version: "1.0.0",
	aiConfig: {
